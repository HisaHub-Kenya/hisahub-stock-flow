...
export var useAIChat = function (userId) {
    var _a = useState([]), messages = _a[0], setMessages = _a[1];
    var _b = useState(false), loading = _b[0], setLoading = _b[1];
    var _c = useState(null), sessionId = _c[0], setSessionId = _c[1];
    var toast = useToast().toast;
    var sendMessage = function (message) { return __awaiter(void 0, void 0, void 0, function () {
        var userMessage, functions, aiAssistant, result, data, aiMessage_1, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!userId || !message.trim() || loading)
                        return [2 /*return*/];
                    setLoading(true);
                ...
                case 1:
                    ...
                    aiAssistant = httpsCallable(functions, "aiAssistant");
                    return [4 /*yield*/, aiAssistant({
                            message: message,
                            user_id: userId,
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error("AI Chat error:", err_1);
                    toast({
                        title: "Chat Error",
