...
export var useUserProfile = function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, apiHelpers.getProfile()];
                case 1:
                    data = _a.sent();
                    setProfile(data);
                    return [3 /*break*/, 4];
                case 2:
                    ...
                    toast.error("Failed to load profile: ".concat(message));
                    return [3 /*break*/, 4];
                case 3:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    var updateProfile = function (updates) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, 3, 4]);
                    setUpdating(true);
                    return [4 /*yield*/, apiHelpers.updateProfile(updates)];
                case 1:
                    data = _a.sent();
                    setProfile(data);
                ...
                case 2:
                    ...
                    toast.error("Failed to update profile: ".concat(message));
